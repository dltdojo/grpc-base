...
import (
	...
	"github.com/dltdojo/grpc-base/server"

	// Static files
	_ "github.com/dltdojo/grpc-base/statik"
)
...
func main() {
	...
	pb.RegisterOpenHcosServiceServer(s,  server.New())
	...
	err = pb.RegisterOpenHcosServiceHandler(context.Background(), gwmux, conn)
	if err != nil {
	...
	log.Info("Serving gRPC-Gateway on https://", gatewayAddr,"/gateway")
